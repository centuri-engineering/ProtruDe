 ...
 *23 octobre 2007
 */
public class AboutWindowAFM extends JFrame {

    /**
     *  Constructor for the AboutWindow object
     */
    public AboutWindowAFM() {
    ...
    public JLabel version() {
        JLabel label = new JLabel("AFMJ version 1.1");
    ...
    public JLabel authors() {
        JLabel curie = new JLabel("T. BOUDIER, P. FECHNER, , S. SCHEURING");
